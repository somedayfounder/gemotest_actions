...
SOURCES = [
    # (lab, type, method, url_or_sitemap, filter/pattern)
    ("Гемотест",  "news",    "html_links",  "https://gemotest.ru/info/news/",
     r'href="(/info/news/\d[^"?#]{3,})"'),
    ...
    ("ДНКом",     "news",    "html_links",  "https://dnkom.ru/o-kompanii/novosti/",
     r'href="(/o-kompanii/novosti/[^"?#]{10,})"'),
    ...
    ("Инвитро",   "news",    "html_links",  f"https://www.invitro.ru/moscow/about/news/year-{date.today().year}/",
     r'href="(/moscow/about/news/(?!year)[^"?#]{10,})"'),
...
def run():
    ...
    last_page = seen.get("_gorlab_last_page", 108)
    try:
